...
argument-hint: "[scope glob] [--intensity=0-100] [--target=screen|headset|both] [--backdrop-control=owned|arbitrary] [--material=glass|solid] [--density=compact|regular|spacious] [--a11y-target=AA|AAA]"
allowed-tools:
  - Read
  - Glob
  - Grep
