...
argument-hint: "[scope glob] [--intensity=0-100] [--density=comfortable|cozy|compact] [--dark-mode=none|media|class] [--framework=vanilla-css|tailwind-v4|react|vue|svelte|swiftui|react-native]"
allowed-tools:
  - Read
  - Glob
  - Grep
