...
argument-hint: "[scope glob] [--intensity=0-100] [--scope=controls|controls+cards|all] [--density=compact|comfortable|spacious] [--light-source=top-left|top-right|bottom-right|bottom-left] [--dark-mode=none|media|class|both] [--a11y-mode=strict|standard] [--dry-run]"
allowed-tools:
  - Read
  - Glob
  - Grep
