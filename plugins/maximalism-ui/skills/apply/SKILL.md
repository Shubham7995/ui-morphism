...
argument-hint: "[scope glob] [--intensity=0-100] [--surface-type=brand|campaign|editorial|app-accent] [--density=airy|standard|packed] [--dark-mode=media|class|none] [--motion=full|state-only|none]"
allowed-tools:
  - Read
  - Glob
  - Grep
